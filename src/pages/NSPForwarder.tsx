...
import { extractIcon, extractNACP, isNRO } from '../utils/nro'
...
const NSPForwarder = () => {
  ...
  const [titleId, setTitleId] = useState(`010${'0'.repeat(14)}`)
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            >
              ...
              <p className="text-xl text-blue-300 mb-4">{t('nspForwarder.subtitle')}</p>
            </motion.div>
          </motion.div>
                      ...
                      {imagePreview ? (
                        ...
                        >
                          <img
                            src={imagePreview}
                            alt="Preview"
                            className="w-40 h-40 object-cover rounded-lg shadow-lg ring-2 ring-blue-500/20"
                          />
                          <p className="text-sm text-gray-400 mt-3 text-center">
                            {t('nspForwarder.upload.clickToChangeImage')}
                          </p>
                        </motion.div>
                      ) : (
                        <motion.div
                        ...
                        >
                          ...
                          <p className="text-sm text-gray-300 font-medium mb-1">
                            {mode === 'nro'
                              ? nroFile
                                ? t('nspForwarder.upload.selectImage')
                                : t('nspForwarder.upload.selectNro')
                      ...
                      {logoType === 2 && (
                        <div className="grid grid-cols-2 gap-3">
                          ...
                          >
                            {animationFile
                              ? animationFile.name
                              : t('nspForwarder.form.animation.select')}
                          </button>
                          <input
                            ref={logoInputRef}
                            type="file"
                        ...
                        {[
                          {
                            ...
                            setter: setEnableScreenshots,
                            label: t('nspForwarder.form.options.screenshots'),
                          },
                          {
                            checked: enableVideoCapture,
                            setter: setEnableVideoCapture,
                            label: t('nspForwarder.form.options.videoCapture'),
                          },
                          {
                            checked: enableProfileSelector,
                            setter: setEnableProfileSelector,
                            label: t('nspForwarder.form.options.profileSelector'),
                          },
                          {
                            checked: enableSvcDebug,
                            setter: setEnableSvcDebug,
                            label: t('nspForwarder.form.options.svcDebug'),
                          },
                        ].map((option, idx) => (
                          <label
                            key={idx}
              ...
              >
                <div className="space-y-5">
                  ...
                  <div>
                    ...
                    >
                      <span className="truncate text-sm">
                        {prodKeysFile ? prodKeysFile.name : t('nspForwarder.form.prodKeys.select')}
                      </span>
                      {prodKeysFile && <Check className="w-5 h-5 text-green-400 flex-shrink-0" />}
                    </button>
                    <input
                      ref={prodKeysInputRef}
                      type="file"
                      accept=".keys"
                      onChange={handleProdKeysUpload}
                      className="hidden"
                    />
                    <p className="text-xs text-gray-500 mt-1">
                      {t('nspForwarder.form.prodKeys.help')}
                    </p>
                  </div>
                  ...
                  <motion.button
                    ...
                    aria-label={
                      isGenerating
                        ? t('nspForwarder.buttons.generating')
                        : t('nspForwarder.buttons.generate')
                    }
