        ...
        <>
          ...
          >
            ...
            >
              ...
              <div className="flex-shrink-0 px-2 py-2">
                {mainNavItems.map((item, index) => (
                  <motion.div key={item.path} variants={itemVariants} custom={index}>
                    <motion.div whileTap={{ scale: 0.98 }} className="mx-2 my-1">
                      <Link
                        to={item.path}
                        onClick={onClose}
              ...
              <motion.div variants={itemVariants} className="flex-shrink-0 px-4 py-2">
                <motion.a
              ...
              <motion.div variants={itemVariants} className="flex-shrink-0 px-4 py-3">
