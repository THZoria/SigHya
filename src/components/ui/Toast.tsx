 ...
 * Provides context for adding and removing toasts throughout the app
 */
      ...
      <AnimatePresence>
        {toasts.map((toast) => (
          <motion.div
            ...
            className={`max-w-sm w-full p-4 rounded-lg border backdrop-blur-sm shadow-lg ${getToastStyles(toast.type)}`}
            role="alert"
            aria-live="assertive"
          >
